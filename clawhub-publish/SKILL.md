...
3. **Install the CLI** — `pip install snaplii-cli==0.12.0` ([PyPI](https://pypi.org/project/snaplii-cli/) | [Source](https://github.com/Snaplii-Inc/agent-to-merchant-payments))
...
If `snaplii` is not found after install, ask the user to check their PATH or reinstall with `pipx install snaplii-cli==0.12.0`.
...
- `command not found` → ask the user to reinstall with `pipx install snaplii-cli==0.12.0`.
